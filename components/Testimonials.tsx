        ...
        >
          <SwiperSlide>
            <p className="text-[16px] font-switzer font-[400] leading-[30px] text-center text-[#262626] ">
              “After countless failed ventures, RAF's partnership investment was
              a game-changer for me. I not only regained my investment footing
              but discovered numerous lucrative opportunities. The consistency
              and support have been impeccable!”
            </p>
