...
export default function SecureFuture() {
  return (
    <div className="bg-black mx-auto w-full py-20">
      <div className="flex flex-col max-w-screen-xl items-center text-center justify-center">
        ...
        <h1 className="text-[31px] text-white capitalize font-[500] font-switzer -mt-4">
          With RAF Vaults
        </h1>
        <p className="text-white font-[400] text-[14px] font-switzer mt-4 sm:w-[50%] w-[80%]">
