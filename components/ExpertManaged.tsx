    ...
    <div className="w-full mt-32 mx-auto">
      <div className="max-w-[600px] w-full mx-auto">
        ...
        <p className="text-[#595959] font-[400] text-[15px] text-center">
          Leave the complexities of investing to our professionals. Our curated
          portfolios are designed to match your risk tolerance and financial
          goals. Monitor your investment performance in real-time and watch your
          wealth grow.
        </p>
      </div>
      <div className="sm:block flex justify-center">
        <div className="mt-8 sm:grid-cols-2 grid-cols-1 sm: grid gap-3 max-w-[680px] mx-auto">
