...
const Vault = () => {
    ...
    return (
      <>
        <Head>
            <title>Vault | RAF</title>
            <meta
                name="description"
                content="RAF Vault is a specialized savings tool that allows you to lock away your funds for a predetermined period, earning substantial returns in the process."
            />
        </Head>
        ...
        <div className="h-screen max-w-screen-xl mx-auto px-10 w-full">
            ...
            <div className="w-1/2 mmd:w-full">
              <div className="mb-5">
                ...
                <span className="text-[#595959] leading-[25px] font-[400] text-[15px] ">
                  As part of the innovative RAF fintech ecosystem, RAF Vault
                  takes your savings strategy to the next level, offering you
                  the power to grow your <br className="hidden md:block" />{' '}
          ...
          <section className="mt-32 xd:grid-cols-1 grid-cols-2 grid gap-3 items-start justify-between">
            ...
            <p className="text-[#52525B] font-switzer font-[400] text-[16px]">
              ...
              <br />
              <br />
              While RAF Plan helps you save systematically for specific goals
              like education, a new home, or a car, RAF Vault is designed for
              those looking to maximize their returns on larger sums. It's the
              perfect complement to your regular savings, offering a way to make
